export enum PacketType {
	...
	ISP_PIT = 26,		// 26 - info			: pit stop start
	...
	ISP_BTN = 45,		// 45 - instruction		: show a button on local or remote screen
	...
	ISP_OBH = 51,		// 51 - info			: contact car + object (collision report)
	...
	ISP_NCI = 57,		// 57 - info			: new connection - extra info for host
	...
	ISP_SLC = 62,		// 62 - info			: connection selected a car
